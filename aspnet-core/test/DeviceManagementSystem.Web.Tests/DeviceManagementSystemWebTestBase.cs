...
using DeviceManagementSystem.Models.TokenAuth;
...
{
    public abstract class DeviceManagementSystemWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static DeviceManagementSystemWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(DeviceManagementSystemWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<DeviceManagementSystemDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<DeviceManagementSystemDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<DeviceManagementSystemDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<DeviceManagementSystemDbContext, Task<T>> func)
        {
            T result;
